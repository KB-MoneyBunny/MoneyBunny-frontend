...
<template>
  <div class="emailVerifyContainer">
    <div class="card">
      ...
      <p class="subtitle font-14">이메일로 인증을 진행해주세요</p>
      ...
      <div class="formGroup">
        <label for="email" class="font-14 font-bold">이메일 인증</label>
        <div class="emailRow">
          <input
            type="email"
            id="email"
          ...
          />
          <button
            class="verifyButton font-12 font-bold"
            @click="checkEmail"
            :disabled="isExpired"
      ...
      <div v-if="isCodeSent" class="formGroup">
        <label for="code" class="font-15">인증 코드</label>
        <div class="emailRow">
          <input
            type="text"
            id="code"
      ...
      <div class="buttonGroup">
        <button class="backButton font-15" @click="goBack">이전</button>
        <button class="nextButton font-15" @click="goNext">다음</button>
      </div>
    </div>
  </div>
</template>
